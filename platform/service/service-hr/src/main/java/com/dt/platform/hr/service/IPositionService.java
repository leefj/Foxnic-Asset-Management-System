...
public interface IPositionService extends  ISimpleIdService<Position,String> {
	 ...
	 */
	Result insert(Position position,boolean throwsException);
	 ...
	 * @return 结果
	 */
	Result update(Position position , SaveMode mode,boolean throwsException);
	 ...
	 * @return 保存是否成功
	 * */
	Result save(Position position , SaveMode mode,boolean throwsException);
	 ...
	 * @return 实体集
	 * */
	List<Position> queryListByIds(List<String> ids);

	/**
	 * 按 id 列表查询 Map
	 * @param ids  主键清单
	 * */
	Map<String, Position> queryMapByIds(List<String> ids);
	 ...
	 * @return 判断结果
	 */
	Boolean checkExists(Position position);
	 ...
	 * @return 查询结果
	 * */
	List<Position> queryList(PositionVO sample);
	 ...
	 * @return 查询结果
	 * */
	PagedList<Position> queryPagedList(PositionVO sample,int pageSize,int pageIndex);
