...
public class PersonContractVOMeta extends PersonContractMeta {
	...
	*/
	 ...
	 * 人员 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.PersonContractVO,java.lang.String> PERSON_ID_PROP = new BeanProperty(com.dt.platform.domain.hr.PersonContractVO.class ,PERSON_ID, java.lang.String.class, "人员", "人员", java.lang.String.class, null);
	...
	*/
	 ...
	 * 合同周期 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.PersonContractVO,java.lang.String> CONTRACT_DURATION_PROP = new BeanProperty(com.dt.platform.domain.hr.PersonContractVO.class ,CONTRACT_DURATION, java.lang.String.class, "合同周期", "合同周期", java.lang.String.class, null);
	...
	*/
	 ...
	 * 合同开始时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.PersonContractVO,java.util.Date> CONTRACT_START_DATE_PROP = new BeanProperty(com.dt.platform.domain.hr.PersonContractVO.class ,CONTRACT_START_DATE, java.util.Date.class, "合同开始时间", "合同开始时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 合同结束时间 , 类型: java.util.Date
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.PersonContractVO,java.util.Date> CONTRACT_FINISH_DATE_PROP = new BeanProperty(com.dt.platform.domain.hr.PersonContractVO.class ,CONTRACT_FINISH_DATE, java.util.Date.class, "合同结束时间", "合同结束时间", java.util.Date.class, null);
	...
	*/
	 ...
	 * 合同 , 类型: java.lang.String
	*/
	public static final BeanProperty<com.dt.platform.domain.hr.PersonContractVO,java.lang.String> FILE_ID_PROP = new BeanProperty(com.dt.platform.domain.hr.PersonContractVO.class ,FILE_ID, java.lang.String.class, "合同", "合同", java.lang.String.class, null);
